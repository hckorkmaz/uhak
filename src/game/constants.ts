...
export const LEVELS: LevelConfig[] = [
  {
    ...
    spawnInterval: CLOUD_SPAWN_INTERVAL + 500,
    gapMultiplier: 1.45,
    maxGapMultiplier: 1.10,
  ...
  },
  {
    ...
    targetScore: 10,
    speedMultiplier: 1,
    spawnInterval: CLOUD_SPAWN_INTERVAL + 250,
    gapMultiplier: 1.20,
    maxGapMultiplier: 0.95,
  ...
  },
  {
    ...
    spawnInterval: CLOUD_SPAWN_INTERVAL,
    gapMultiplier: 1.00,
    maxGapMultiplier: 0.95,
